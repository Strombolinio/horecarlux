...
import type { CreateReservationResult as _CreateReservationResult, Reservation as _Reservation, ReservationId as _ReservationId, ReservationStatus as _ReservationStatus, RoomId as _RoomId, StripeSessionStatus as _StripeSessionStatus, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async checkAvailability(arg0: RoomId, arg1: bigint, arg2: bigint): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async confirmReservation(arg0: ReservationId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async createDepositPaymentIntent(arg0: ReservationId): Promise<{
        __kind__: "ok";
        ok: string;
    } | {
        __kind__: "err";
        ...
        if (this.processError) {
            try {
                const result = await this.actor.createDepositPaymentIntent(arg0);
    ...
    async createReservation(arg0: string, arg1: string, arg2: string, arg3: RoomId, arg4: bigint, arg5: bigint, arg6: bigint): Promise<CreateReservationResult> {
        if (this.processError) {
            try {
                const result = await this.actor.createReservation(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
                return from_candid_CreateReservationResult_n4(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async listReservations(): Promise<Array<Reservation>> {
        if (this.processError) {
            try {
                const result = await this.actor.listReservations();
    ...
    async recordDepositPaid(arg0: ReservationId, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.recordDepositPaid(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async rejectReservation(arg0: ReservationId, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.rejectReservation(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_CreateReservationResult_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _CreateReservationResult): CreateReservationResult {
...
function from_candid_opt_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Reservation]): Reservation | null {
    return value.length === 0 ? null : from_candid_Reservation_n9(_uploadFile, _downloadFile, value[0]);
}
function from_candid_record_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        stripePaymentIntentId: record_opt_to_undefined(from_candid_opt_n13(_uploadFile, _downloadFile, value.stripePaymentIntentId)),
...
function from_candid_variant_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "Confirmed" in value ? ReservationStatus.Confirmed : "Rejected" in value ? ReservationStatus.Rejected : "Pending" in value ? ReservationStatus.Pending : value;
}
...
function from_candid_vec_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Reservation>): Array<Reservation> {
